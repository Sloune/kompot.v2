...
<header>
    <a href="<?= site_url(); ?>"><img class="header__logo" src="<?= get_template_directory_uri(); ?>/public/img/kp-logo-155x128.png" alt="КОМПОТ"></a>
<!--    <a class="header__logo" href="--><?//= site_url(); ?><!--"><p>компот</p></a>-->
    <nav>
