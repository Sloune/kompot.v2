...
?>
    ...
    <main>
        ...
        <?= do_shortcode('[easy-pricing-table id="32"]'); ?>
        <h1 class="aligncenter">Тарифи на IPTV</h1>
        <?= do_shortcode('[easy-pricing-table id="49"]'); ?>
        <h2 class="aligncenter">Список усіх телеканалів ви зможете переглянути на сайті <a class="link"
        ...
        <div class="plans">
            <div class="plan">
                ...
                <h3>Liqpay</h3>
                <p>Оплата онлайн</p>
                <a href="<?= get_template_directory_uri(); ?>/pay" target="_blank" class="btn btn-primary">Детальніше</a>
            </div>
            <div class="plan">
